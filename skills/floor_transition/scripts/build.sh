...
# floor_transition_rbnx build phase — runs `rbnx codegen` (emits proto_gen for
...
ROS_BASE_IMAGE="${ROBONIX_FLOOR_TRANSITION_ROS_BASE_IMAGE:-robonix-ros:humble-ros-base}"
